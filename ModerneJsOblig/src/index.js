...
try {
  ...
  (function UseArrow1() {
    ...
    //Denne feiler så ikke kommenter ut denn

    // Men den feiler jo, så jeg kommenterer den ut. Denne ser ikke ut til å faktisk gjøre jobben sin.
  ...
  (function UseObjectDestructuring1() {
    ...
    var [name, age, add] = [obj.name, obj.age, obj.add];
